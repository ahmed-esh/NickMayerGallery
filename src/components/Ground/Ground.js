...
const Ground = () => {
    ...
    marbleMap = useMemo(() => new THREE.TextureLoader().load("/NickMayerGallery/assets/Textures/BazaltMarble/BAZALT-diffuse.jpg"), []);
    marbleMap.wrapS = THREE.MirroredRepeatWrapping;
    marbleMap.wrapT = THREE.MirroredRepeatWrapping;
    marbleMap.repeat.set(size, size);

    marbleAlphaMap = useMemo(() => new THREE.TextureLoader().load("/NickMayerGallery/assets/Textures/BazaltMarble/BAZALT-ao.jpg"), []);
    ...
    marbleNormalMap = useMemo(() => new THREE.TextureLoader().load("/NickMayerGallery/assets/Textures/BazaltMarble/BAZALT-normal.jpg"), []);
    ...
    grassMap = useMemo(() => new THREE.TextureLoader().load("/NickMayerGallery/assets/Textures/Grass/GrassGreenTexture0002.jpg"), []);
